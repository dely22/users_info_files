...
server.post('/addUser', (req, res) => {
    ...
    form.parse(req, function(err, fields, files) {
        ...
        if (files) {
            ...
            var Image = getFileInfo(files.photo, '\\public\\files\\imgs\\');
            var CV = getFileInfo(files.cv, '\\public\\files\\cv\\');
...
server.listen(process.env.PORT || 5000, process.env.IP || '0.0.0.0');